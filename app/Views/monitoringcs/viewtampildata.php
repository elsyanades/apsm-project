...
<?= $this->section('title') ?>
<title>APSM | Data Monitoring CS</title>
<?= $this->endSection() ?>
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Data Monitoring-CS</h4>
            </div>
            <div class="card-body">
...
<script>
function datamonitoringcs() {
    $.ajax({
        url: "<?= site_url('monitoringcs/ambildata') ?>",
        dataType: "json",
...
$(document).ready(function() {
    ...
    $('.tomboltambah').click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= site_url('monitoringcs/formtambah') ?>",
            dataType: "json",
            success: function(response) {
    ...
    $('.tomboltambahbanyak').click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= site_url('monitoringcs/formtambahbanyak') ?>",
            dataType: "json",
            beforeSend: function() {
