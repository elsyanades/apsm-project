...
<?= $this->section('content') ?>
    ...
    <div class="page-title-box">
        <h4 class="page-title">Data Vendor</h4>
    </div>
</div>
...
function datavendor() {
    $.ajax({
        url: "<?= site_url('vendors/ambildata') ?>",
        dataType: "json",
...
$(document).ready(function() {
    ...
    $('.tomboltambah').click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= site_url('vendors/formtambah') ?>",
            dataType: "json",
            success: function(response) {
    ...
    $('.tomboltambahbanyak').click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= site_url('vendors/formtambahbanyak') ?>",
            dataType: "json",
            beforeSend: function() {
