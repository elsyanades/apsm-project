...
<?= $this->section('title') ?>
<title>APSM | Data Kepala Operasional</title>
<?= $this->endSection() ?>
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Data Kepala Operasional</h4>
            </div>
            <div class="card-body">
...
<script>
function datakepalaops() {
    $.ajax({
        url: "<?= site_url('kepalaops/ambildata') ?>",
        dataType: "json",
...
$(document).ready(function() {
    ...
    $('.tomboltambah').click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= site_url('kepalaops/formtambah') ?>",
            dataType: "json",
            success: function(response) {
    ...
    $('.tomboltambahbanyak').click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= site_url('kepalaops/formtambahbanyak') ?>",
            dataType: "json",
            beforeSend: function() {
