    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Marketing Project</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?= form_open('marketingproject/simpandata', ['class' => 'formmarketingproject']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="" class="col-sm-5 col-form-label">Status Marketing Project</label>
                    <div class="col-sm-6">
...
$(document).ready(function() {
    $('.formmarketingproject').submit(function(e) {
        e.preventDefault();
        $.ajax({
            type: "post",
