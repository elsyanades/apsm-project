...
<?= $this->section('title') ?>
<title>APSM | Data Marketing Project</title>
<?= $this->endSection() ?>
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Data Marketing Project</h4>
            </div>
            <div class="card-body">
...
<script>
function datamarketingproject() {
    $.ajax({
        url: "<?= site_url('marketingproject/ambildata') ?>",
        dataType: "json",
...
$(document).ready(function() {
    ...
    $('.tomboltambah').click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= site_url('marketingproject/formtambah') ?>",
            dataType: "json",
            success: function(response) {
    ...
    $('.tomboltambahbanyak').click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= site_url('marketingproject/formtambahbanyak') ?>",
            dataType: "json",
            beforeSend: function() {
