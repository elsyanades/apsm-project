...
<?= $this->section('title') ?>
<title>APSM | Data Staff Operasional</title>
<?= $this->endSection() ?>
...
<?= $this->section('content') ?>
    ...
    <div class="page-title-box">
        <h4 class="page-title">Data Staff Operasional</h4>
    </div>
</div>
...
<script>
function datastaffops() {
    $.ajax({
        url: "<?= site_url('staffops/ambildata') ?>",
        dataType: "json",
...
$(document).ready(function() {
    ...
    $('.tomboltambah').click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= site_url('staffops/formtambah') ?>",
            dataType: "json",
            success: function(response) {
    ...
    $('.tomboltambahbanyak').click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= site_url('staffops/formtambahbanyak') ?>",
            dataType: "json",
            beforeSend: function() {
