...
use App\Models\Modeldatamarketingproject;
use Config\Services;

class Marketingproject extends BaseController
{
    public function index()
    {
        ...
        // if (cekakses()) 
        {
            ...
            return view('marketingproject/viewtampildata');
        }
    }
    ...
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            $data =  [
                'tampildata' => $this->markt_proj->findAll()
            ];

            $msg = [
                'data' => view('marketingproject/datamarketingproject', $data)
            ];
    ...
    public function listdata()
    {
        ...
        $datamodel = new Modeldatamarketingproject($request);
    ...
    public function formtambah()
    {
        if ($this->request->isAJAX()) {
            $msg = [
                'data' => view('marketingproject/modaltambah')
            ];
    ...
    public function simpandata()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$valid) {
                ...
                $this->markt_proj->insert($simpandata);

                $msg = [
                    'sukses' => 'Data marketing project berhasil tersimpan'
                ];
            }
            echo json_encode($msg);
        } else {
    ...
    public function formedit()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('marketingproject/modaledit', $data)
            ];
    ...
    public function updatedata()
    {
        if ($this->request->isAJAX()) {
            ...
            $this->markt_proj->update($id, $simpandata);

            $msg = [
                'sukses' => 'Data marketing project berhasil diupdate'
            ];
            echo json_encode($msg);
        } else {
            exit('Maaf tidak dapat diproses');
    ...
    public function hapus()
    {
        if ($this->request->isAJAX()) {
            ...
            $this->markt_proj->delete($id);

            $msg = [
                'sukses' => "Data marketing project berhasil di hapus"
            ];
            echo json_encode($msg);
        }
    }
    ...
    //     if ($this->request->isAJAX()) {
    //         $msg = [
    //             'data' => view('marketingproject/formtambahbanyak')
    //         ];
    ...
    //         $msg = [
    //             'sukses' => view('marketingproject/modalupload', $data)
    //         ];
